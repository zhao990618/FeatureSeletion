...
class CMODESDE:
    ...
    def getElietSet(self):
        ...
        eliteSet,score,bestIndividual = nonDominatedSort(parentPopulation=self.population_DE,fitnessArray=fitArray,solutionlengthArray=lenArray
                         ,dataFeature=self.dataFeature,populationNum=self.alpha)
    ...
    def run(self):
        ...
        # 写入文件的路径
        path_txt = "../result/paretoSolution/CMODE_SDE/" + self.ducName + ".txt"
        # 写入时间
...
if __name__ == '__main__':
    ...
    for file in files:
        ...
        # 写入文件的路径
        path_txt = "../result/result_txt/CMODE_SDE/" + ducName + ".txt"
        # 写入文件的标题
        ...
        genetic.setParameter(populationNum=140, iteratorTime=100, crossoverPro=0.5, F=0.5, alpha=5,eta = 0.6)
