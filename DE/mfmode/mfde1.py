...
class MFMODE:
    ...
    def goRun(self):
        ...
        # 写入文件的路径
        path_txt = "D:/MachineLearningBackUp/实验/paretoSolution/MF-MODE/" + self.dataName + ".txt"
        ...
        # print("最优acc",1 - self.globalFitness)
        # print("最优个体的选择长度为：", self.globalSolutionNum)
        #
        # print("####################################")
...
#
#         # 写入文件的路径
#         path_txt = "D:/MachineLearningBackUp/实验/result_txt/" + ducName + ".txt"
#         # 写入文件的标题
...
#                              , F=0.5, eliteFront=0.01, p=0.05, maxAge=10)
#
#         # 循环多少次
#         iterateT = 2
#
...
if __name__ == '__main__':
    ...
    for file in files:
        ...
        genetic.setParameter(populationNum=70, iteratorTime=100, eliteProb=0.1,crossoverPro=0.9
                             ,F=0.5,eliteFront = 0.01,p = 0.3,maxAge=9)#p = 0.3
