...
class MFMODE3:
    ...
    def goRun(self):
        ...
        # 写入文件的路径
        path_txt = "../result/paretoSolution/EG_MFDE_V3/" + self.dataName + ".txt"
        # 写入时间
...
if __name__ == '__main__':
    ...
    for file in files:
        ...
        # 写入文件的路径
        path_txt = "../result/result_txt/EG_MFDE_V3/" + ducName + ".txt"
        # 写入文件的标题
        ...
        print("获取文件数据", file)
        dataCsv.getData()
        genetic = MFMODE3(dataX=dataCsv.dataX, dataY=dataCsv.dataY,dataName=ducName)
