...
class MFMODE1:
    ...
    def goRun(self):
        ...
        # 写入文件的路径
        path_txt = "D:/MachineLearningBackUp/实验/paretoSolution/MF-MODE-NENG/" + self.dataName + ".txt"
        # 写入时间
...
if __name__ == '__main__':
    ...
    for file in files:
        ...
        # 写入文件的路径
        path_txt = "D:/MachineLearningBackUp/实验/result_txt/MF-MODEVariant/variant1/" + ducName + ".txt"
        # 写入文件的标题
        ...
        print("获取文件数据", file)
        dataCsv.getData()
        genetic = MFMODE1(dataX=dataCsv.dataX, dataY=dataCsv.dataY,dataName=ducName)
