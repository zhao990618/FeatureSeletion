...
from DE.mfmode.operators import getFreq,getAccRecMean
...
class Genetic:
    ...
    def initPopulation(self):
        ...
        #进行反向
        # self.population_task1 = self.opposition_Population(population=self.population_task1,
        #                                                    rule=self.probabilityOfFeatureToSelect)
        # task2 种群
        for i in range(0, int(self.populationNum)):
        ...
        # 进行反向
        # self.population_task2 = self.opposition_Population(population=self.population_task2,
        #                                                    rule=self.scoreOfRelifF)
    ...
    def mate_new(self, taskNum):
        ...
        for i in range(len(taskPopulation)):
            ...
            # solution_u[0] = np.where(u_x < 0.6,1,0)
...
if __name__ == '__main__':
    ...
    genetic.setParameter(populationNum=70, iteratorTime=100, eliteProb=0.2,crossoverPro=0.9
                        ,F=0.5,p=0.3,eliteFront=0.01,maxAge=9)#p = 0.3
    genetic.goRun()
