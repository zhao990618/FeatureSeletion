...
def improved_evaluation(individuals, fit_num,x_train,dataY):
    ...
    for i2 in range(len(index_unique_children)):
        ...
        fit_new[index_unique_children[i2]] = fit_train(individuals[index_unique_children[i2]], x_train,dataY)
        fit_num = fit_num + 1
